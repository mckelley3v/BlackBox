...
template <typename... Ts> constexpr int m1::min(int const arg0, int const arg1, Ts ...argN) noexcept
{
...
template <typename... Ts> constexpr float m1::min(float const arg0, float const arg1, Ts ...argN) noexcept
{
    return min(arg0, min(arg1, argN...));
}
...
template <typename... Ts> constexpr double m1::min(double const arg0, double const arg1, Ts ...argN) noexcept
{
    return min(arg0, min(arg1, argN...));
}
