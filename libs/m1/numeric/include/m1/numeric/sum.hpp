...
template <typename... Ts> constexpr int m1::sum(int const arg0, int const arg1, Ts const ...argN) noexcept
{
...
template <typename... Ts> constexpr float m1::sum(float const arg0, float const arg1, Ts const ...argN) noexcept
{
    return sum(arg0, sum(arg1, argN...));
}
...
template <typename... Ts> constexpr double m1::sum(double const arg0, double const arg1, Ts const ...argN) noexcept
{
    return sum(arg0, sum(arg1, argN...));
}
