...
namespace m1
{
    ...
    public:
        ...
        virtual std::shared_ptr<graphics_texture_source_impl> make_texture_source(graphics_texture_source_definition const &definition) = 0;
        virtual std::shared_ptr<graphics_texture_color_target_impl> make_texture_color_target(graphics_texture_color_target_definition const &definition) = 0;
        virtual std::shared_ptr<graphics_texture_depth_target_impl> make_texture_depth_target(graphics_texture_depth_target_definition const &definition) = 0;
